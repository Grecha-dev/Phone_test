...
function takeSynced(b, amount, msgIndex) {
    ...
    // ВАЖНО: x.at <= msgIndex — иначе очередь матчит записи «из будущего»:
    // теги, обработанные ЭТИМ ЖЕ проходом харвеста, уже лежат в syncQueue
    // (их at = chatLen() > msgIndex), и два одинаковых перевода в одном
    // сообщении съедали друг друга — второй писался в историю без баланса.
